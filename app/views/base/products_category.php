  ...
  <div class="container">
      ...
      <div class="col-lg-12">
        <div class="breadcrumb-trail breadcrumbs">
          <ul class="trail-items breadcrumb">
            ...
            <li class="trail-item trail-end active">Category</li>
            <li class="trail-item trail-end active" id="searchCategory1"></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="content-area shop-grid-content no-banner col-lg-9 col-md-9 col-sm-12 col-xs-12">
        <div class="site-main">
          <h3 class="custom_blog_title">Category: <span id="searchCategory2"></span></h3>
          <!-- Filter -->
...
<script src="<?= BASE_ACTIONS . "/actions_product_category.js" ?>"></script>